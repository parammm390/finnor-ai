...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@finnor/ooxml": r("./packages/ooxml/src/index.ts"),
      "@finnor/spreadsheet-ir": r("./packages/spreadsheet-ir/src/index.ts"),
      "@finnor/document-ir": r("./packages/document-ir/src/index.ts"),
      "@finnor/presentation-ir": r("./packages/presentation-ir/src/index.ts"),
      "@finnor/artifacts": r("./packages/artifacts/src/index.ts"),
