...
export const P7_MANDATORY_CASES: readonly P7MandatoryCase[] = [
  ...
  { id: "p7.frontend", group: "frontend-truth", statement: "Centropy reads server-owned workforce truth, shows explicit source states, and contains no static fleet authority.", gates: ["architecture", "typecheck-contracts"] },
