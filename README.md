...
- `/centropy` — command context and operating attention
- `/centropy/deals` — PE object world and Company Brain
- `/centropy/work` — Work, plans, execution, proof, and recovery
- `/centropy/agents` — governed workforce and reviewed learning
...
The browser needs the configured Supabase public values for authentication and `NEXT_PUBLIC_OS_API_URL` for the Centropy API. Secrets remain server-side. See `.env.example` for the current environment contract.
