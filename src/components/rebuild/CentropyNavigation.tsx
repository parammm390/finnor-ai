...
import { CentropyMark } from "./CentropyMark";
import styles from "./CentropyNavigation.module.css";
...
export default function CentropyNavigation({ tone = "light" }: { tone?: "light" | "dark" }) {
  ...
  return (
    <header className={styles.navigation} data-scrolled={isScrolled} data-tone={tone}>
      <div className={styles.rail}>
        <Link className={styles.wordmark} href="/" aria-label="Centropy home">
          <span className={styles.wordmarkMark}><CentropyMark className={styles.markSvg} /></span>
          <span className={styles.wordmarkText}>Centropy</span>
        ...
        <div className={styles.utilityNav}>
          <Link className={styles.signIn} href="/centropy/login">
            <span className={styles.stateDot} aria-hidden="true" />CENTROPY sign in
          </Link>
        ...
        <Link className={styles.mobileStatus} href="/centropy/login" aria-label="Open CENTROPY sign in">
            ...
            >
              <div className={styles.drawerInner}>
                <div className={styles.drawerContext}>
                  ...
                  <span>Centropy / PRIVATE EQUITY INFRASTRUCTURE</span>
                </div>
                ...
                <div className={styles.drawerActions}>
                  <Link className={styles.drawerSignIn} href="/centropy/login" onClick={closeDrawer}>
                    CENTROPY sign in
                  </Link>
                  <a
