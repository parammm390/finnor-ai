...
export const metadata: Metadata = {
  title: "Terms",
  description: "Terms overview for the Centropy website and separately agreed production deployments.",
  ...
  return (
    <LegalPage>
      <article className={styles.legal}>
        <span className={styles.legalMeta}>Centropy / Terms overview</span>
        <h1>Terms</h1>
        <div className={styles.legalBody}>
          ...
          <section><h2>Website materials</h2><p>Descriptions, diagrams, synthetic workflows and interface states on this website explain Centropy. They are not legal, tax, accounting, investment or operational advice.</p></section>
          <section><h2>No production authorization</h2><p>Using this website or contacting Centropy does not authorize Centropy or CENTROPY to act in your business. Production execution requires a separately agreed scope, configured access, policies, authority boundaries and certification.</p></section>
