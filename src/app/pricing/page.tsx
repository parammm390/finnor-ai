...
export const metadata: Metadata = {
  title: "Pricing",
  description:
    "Scope a Centropy deployment by PE sources, underwriting and IC coverage, Work, integrations, authority, workspace engineering, reliability, and support. Production starts around $30,000.",
  alternates: { canonical: "https://finnorai.com/pricing" },
  openGraph: {
    title: "Pricing | Centropy",
    ...
    images: [{ url: "https://finnorai.com/og-image.svg", width: 1200, height: 630, alt: "Centropy deployment pricing" }],
  },
};
