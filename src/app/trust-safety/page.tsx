...
export const metadata: Metadata = {
  title: "Trust & Safety",
  description:
    "How Centropy preserves source-backed PE context, uncertainty, tenant isolation, authority, governed execution, recovery, evidence, receipts, and proof.",
  alternates: {
    canonical: "https://finnorai.com/trust-safety",
  },
  openGraph: {
    title: "Trust & Safety | Centropy",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Centropy CENTROPY trust and safety",
      },
    ],
  },
  twitter: {
